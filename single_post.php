      ...
      <div id="respond">
        <form action="process.php" method="post">
          ...
          <p>
			...
			<input type="hidden" value="<?php echo $_REQUEST['pid'];?>" name="postid"/>
			
            <label for="comment" style="display:none;"><small>Comment (required)</small></label>
          </p>
          <p>
            <input name="docomment" id="submit" value="Post Comment" type="submit">
            &nbsp;
            <input name="reset" id="reset" tabindex="5" value="Reset" type="reset">
          </p>
        </form>
      </div>
	  <?php
